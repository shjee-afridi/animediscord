...
export async function generateMetadata({ params }: { params: { slug?: string[] } }): Promise<Metadata> {
  ...
  const title = safeTerm
    ...
    : 'Find Any Discord Server | Anime Discord';
    ...
    <main className="max-w-2xl mx-auto py-16 px-4 text-center">
      ...
      <div className="mt-10">
        ...
        <div className="text-left max-w-xl mx-auto">
          <h3 className="font-bold">Can I find SFW, porn, Anime, nudes, or OnlyFans Discord servers here?</h3>
          <p>Yes! Our platform helps you discover a wide range of Discord servers, including SFW, adult, Anime, and other 18+ communities. Even if your search is unique, you'll find top Discord communities to join.</p>
        </div>
      </div>
      */}
    </main>
