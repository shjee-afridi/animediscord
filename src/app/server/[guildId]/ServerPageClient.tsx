          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "url": `https://animediscord.com/server/${params.guildId}`,
                "image": server.icon ? `https://cdn.discordapp.com/icons/${params.guildId}/${server.icon}.png?size=512` : "https://animediscord.com/icon-512x512.png",
                "brand": {
                  "@type": "Brand",
                  "name": server.name
                },
                ...
                "offers": {
                  ...
                  "url": server.inviteCode ? `https://discord.gg/${server.inviteCode}` : `https://animediscord.com/server/${params.guildId}`
                },
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                "@context": "https://schema.org",
                "@type": "WebPage",
                "name": `${server.name} Discord Server - Anime Discord`,
                ...
                "breadcrumb": {
                  ...
                  "itemListElement": [
                    ...
                    },
                    {
                      ...
                      "position": 3,
                      "name": server.name,
                      "item": `https://animediscord.com/server/${params.guildId}`
                    }
                  ]
                }
              })
