...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  try {
    ...
    const enhancedDescription = server.description ? 
      ...
      `Join ${server.name} Discord server with ${server.memberCount || 'thousands of'} active members. Discover amazing Discord communities on Anime Discord directory.`;
    ...
    return {
      title: 'Discord Server - Anime Discord',
      description: 'Discover amazing Discord servers on Anime Discord directory.'
    };
  }
}
