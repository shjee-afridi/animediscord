...
import { FaTachometerAlt, FaPlusCircle, FaServer, FaRobot } from 'react-icons/fa';
...
export default function Dashboard() {
  ...
  const handleInviteBot = () => {
    ...
    const inviteUrl = `https://discord.com/oauth2/authorize?client_id=1366467731200675871&permissions=8&scope=bot&guild_id=${selectedGuild}&redirect_uri=${encodeURIComponent('http://animediscord.com/dashboard')}&response_type=code`;
