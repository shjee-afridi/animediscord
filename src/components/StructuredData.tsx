      ...
      const structuredData = {
        ...
        "itemListElement": servers.map((server, index) => ({
          ...
          "item": {
            ...
            "url": `https://animediscord.com/server/${server.guildId}`,
            "image": server.icon ? `https://cdn.discordapp.com/icons/${server.guildId}/${server.icon}.png?size=512` : "https://animediscord.com/icon-512x512.png",
